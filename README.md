...
| 경로 | 기간 | 핵심 스킬 | 목표 |
|------|------|----------|------|
| **초급** (필수) | 첫 2주 | product-strategy, market-segments, beachhead-segment, competitor-analysis, value-proposition, north-star-metric, pricing-strategy, customer-journey-map, brainstorm-experiments | "누구에게 어떤 가치를 줄 것인가" 답변 |
| **중급** (전략 수립) | 3~4주차 | prioritization-frameworks, brainstorm-okrs, gtm-strategy, pre-mortem, outcome-roadmap, create-prd | 전략을 실행 가능한 계획으로 전환 |
| **고급** (성장/최적화) | 5주차 이후 | growth-loops, cohort-analysis, ab-test-analysis, lean-canvas, business-model, ansoff-matrix | 데이터 기반 성장 전략 |
